...
fileInputCsv = "D:/EverythingD/01SRH-BDBA Acads/Blk7-DataStoryTelling/Data4Analysis/NYCPedestrianDataPrepared-20190905-clean3.csv"
...
def insertIntoMongoDb(df):
    ...
    #print(f"\n\n\n\t\t\t\tDataframe=\n{df}")
    #logging.warning(f"\n\n\n\t\t\t\tDataframe=\n{df}")
    jsonFileName = 'D:/EverythingD/01SRH-BDBA Acads/Blk7-DataStoryTelling/Data4Analysis/temp-NYCPedestrian-' + str( nRowsRead ) + 'rows' + str( nRowsSkip ) + 'skipped.json'
